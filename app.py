...
FLOW = [
    ...
    {"key":"state","en":f"Which state do you live in?\n{_state_options}","mr":f"तुम्ही कोणत्या राज्यात राहता?\n{_state_options}","hi":f"आप किस राज्य में रहते हैं?\n{_state_options}","gu":f"તમે કયા રાજ્યમાં રહો છો?\n{_state_options}","bn":f"আপনি কোন রাজ্যে থাকেন?\n{_state_options}","ta":f"நீங்கள் எந்த மாநிலத்தில் வசிக்கிறீர்கள்?\n{_state_options}","te":f"మీరు ఏ రాష్ట్రంలో నివసిస్తున్నారు?\n{_state_options}","kn":f"ನೀವು ಯಾವ ರಾಜ್ಯದಲ್ಲಿ ವಾಸಿಸುತ್ತೀರಿ?\n{_state_options}","ml":f"നിങ്ങൾ ഏത് സംസ്ഥാനത്താണ് താമസിക്കുന്നത്?\n{_state_options}","or":f"ଆପଣ କେଉଁ ରାଜ୍ୟରେ ରୁହନ୍ତି?\n{_state_options}","as":f"আপুনি কোন ৰাজ্যত থাকে?\n{_state_options}","pa":f"ਤੁਸੀਂ ਕਿਸ ਰਾਜ ਵਿੱਚ ਰਹਿੰਦੇ ਹੋ?\n{_state_options}"},
    {"key":"age","en":"Age?\n1. Under 18\n2. 18-25\n3. 26-35\n4. 36-60\n5. 60+","mr":"वय?\n1. 18 पेक्षा कमी\n2. 18-25\n3. 26-35\n4. 36-60\n5. 60+","hi":"उम्र?\n1. 18 से कम\n2. 18-25\n3. 26-35\n4. 36-60\n5. 60+","gu":"ઉંમર?\n1. 18 થી ઓછી\n2. 18-25\n3. 26-35\n4. 36-60\n5. 60+","bn":"বয়স?\n1. 18 এর কম\n2. 18-25\n3. 26-35\n4. 36-60\n5. 60+","ta":"வயது?\n1. 18 க்கும் குறைவு\n2. 18-25\n3. 26-35\n4. 36-60\n5. 60+","te":"వయస్సు?\n1. 18 కంటే తక్కువ\n2. 18-25\n3. 26-35\n4. 36-60\n5. 60+","kn":"ವಯಸ್ಸು?\n1. 18 ಕ್ಕಿಂತ ಕಡಿಮೆ\n2. 18-25\n3. 26-35\n4. 36-60\n5. 60+","ml":"പ്രായം?\n1. 18 വയസ്സിന് താഴെ\n2. 18-25\n3. 26-35\n4. 36-60\n5. 60+","or":"ବୟସ?\n1. 18 ରୁ କମ୍\n2. 18-25\n3. 26-35\n4. 36-60\n5. 60+","as":"বয়স?\n1. 18 তকৈ কম\n2. 18-25\n3. 26-35\n4. 36-60\n5. 60+","pa":"ਉਮਰ?\n1. 18 ਤੋਂ ਘੱਟ\n2. 18-25\n3. 26-35\n4. 36-60\n5. 60+"},
...
def whatsapp():
    ...
    if session["step"] >= len(FLOW):
        ...
        if idx == 0:
            next_q = DISCLAIMER.get(lang, DISCLAIMER["1"]) + "\n\n" + next_q
        msg.body(next_q)
